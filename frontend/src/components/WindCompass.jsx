...
export default function WindCompass({ direction, degrees, speed }) {
  ...
  return (
    <div className="glass compass-container animate-in">
      <span className="detail-label" style={{marginBottom:2,fontSize:".68rem"}}>🧭 Direction du vent</span>
      ...
      <div className="compass-info">
        ...
        <div className="speed">{speed!=null?`${speed} m/s`:""} · {windDescription(direction)}</div>
      </div>
    </div>
  );
}