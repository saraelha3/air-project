...
export default function ProbabilityChart({ probabilities }) {
  ...
  const CustomTooltip = ({ active, payload }) => {
    ...
    return (<div style={{background:"rgba(9,21,16,.97)",border:`1px solid ${d.color}40`,borderRadius:10,padding:"10px 14px",fontSize:".78rem",boxShadow:"0 4px 20px rgba(0,0,0,.4)"}}>
